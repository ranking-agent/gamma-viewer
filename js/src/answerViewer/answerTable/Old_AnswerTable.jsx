...
class AnswerTable extends React.Component {
  ...
  subComponentFactory({ nodeId = null, activeButtonKey = answersetSubComponentEnum.graph } = {}) {
    return (rowInfo) => { // eslint-disable-line
  ...
  isSelected(rowInfo) { return Boolean(this.state.expanded[rowInfo.viewIndex]); }
    ...
    return (
      <div>
        {Object.keys(answers).length ? (
          ...
          <p>There do not appear to be any answers for this question.</p>
        )}
      </div>
    );
  }
