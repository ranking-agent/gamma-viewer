...
import { FaThList, FaClone, FaFileCode, FaEllipsisH, FaAngleDown } from 'react-icons/fa';
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span className="valign-center"><FaFileCode /><span style={{ paddingLeft: '5px' }}>JSON</span></span>
            </Button>
            <Button
